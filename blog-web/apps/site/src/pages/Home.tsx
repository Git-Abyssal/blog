              ...
              {(['latest', 'hot'] as const).map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`relative flex min-h-[52px] items-center px-3 text-sm font-semibold transition-colors first:-ml-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-blue focus-visible:ring-offset-2 ${
