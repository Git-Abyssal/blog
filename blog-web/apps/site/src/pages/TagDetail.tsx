    ...
    <div className="mx-auto max-w-[69rem] py-8 sm:py-10">
      <header className="mb-2 border-b border-slate-200 pb-6 dark:border-slate-800">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <h1 id="tag-heading" className="text-2xl font-black tracking-tight text-slate-950 sm:text-3xl dark:text-white">
            {tagName || '标签文章'}
          </h1>
      ...
      <section aria-labelledby="tag-heading">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center border-b border-slate-300 py-14 text-center sm:py-16 dark:border-slate-700" role="alert">
            ...
            <p className="mt-4 font-semibold text-slate-950 dark:text-white">标签文章暂时加载失败</p>
            <button
              type="button"
              onClick={() => refetch()}
          ...
          <div className="border-b border-slate-300 py-14 text-center sm:py-16 dark:border-slate-700">
            <p className="font-semibold text-slate-950 dark:text-white">该标签下暂无文章</p>
          </div>
        )}
      </section>
    </div>
